// important: not all versions of the esp32 board support package work with this script!
...
#define BUFFER_SIZE 1500  // Define the size of the buffer
struct SensorData {
  float accX;
  float accY;
  float accZ;
...
void loop() {
  ...
  if (bufferIndex >= BUFFER_SIZE || millis() - lastSaveTime >= 5000) {
